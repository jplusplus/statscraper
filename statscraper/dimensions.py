...
class SourceId(Dimension):
    """A key or identifyer used by the data source."""
    def __repr__(self):
        return '<Dimension, SourceId>'


class SourceName(Dimension):
    """A name used by the data source."""
    def __repr__(self):
        return '<Dimension, SourceName>'
...
class MunicipalityCode(Dimension):
    """Swedish municipality code."""
    allowed_values = ['0114','0115','0117','0120','0123','0125','0126','0127',
    ...
    def __repr__(self):
        return '<Dimension, MunicipalityCode>'


class CountyCode(Dimension):
    allowed_values = ['03','04','05','06','07','08','09','10','12','13','14',
                      '17','18','19','20','21','22','23','24','25']
    allowed_dtypes = [str]

    def __repr__(self):
        return '<Dimension, CountyCode>'
...
class Place(Dimension):
    """A geographical location (ort)."""
    allowed_dtypes = [str]

    def __repr__(self):
        return '<Dimension, Place>'


class Custom(Dimension):
    """A custom dimension."""
    pass
